...
//			count = db.update(TABLE_BILL, values, where, selectionArgs);
            ...
            count = sb.table(TABLE_BILL).update(db, values);
			break;
...
//			count = db.update(TABLE_MEMBER, values, where, selectionArgs);
            ...
            count = sb.table(TABLE_MEMBER).update(db, values);
            break;

		case HOUSEMATE_ID:
			idString = uri.getLastPathSegment();
//			count = db.update(TABLE_MEMBER, values, "_id=" + idString + where, selectionArgs);
...
//			count = db.update(TABLE_PAYMENT, values, where, selectionArgs);
            ...
            count = sb.table(TABLE_PAYMENT).update(db, values);
			break;

		case PAYMENT_ID:
			idString = uri.getLastPathSegment();
//			count = db.update(TABLE_PAYMENT, values, "_id=" + idString + where, selectionArgs);
...
//			count = db.update(TABLE_PAYMENT_INFO, values, where, selectionArgs);
            ...
            count = sb.table(TABLE_PAYMENT_INFO).update(db, values);
			break;
			
		case PAYMENT_INFO_ID:
			idString = uri.getLastPathSegment();
//			count = db.update(TABLE_PAYMENT_INFO, values, "_id=" + idString + where, selectionArgs);
